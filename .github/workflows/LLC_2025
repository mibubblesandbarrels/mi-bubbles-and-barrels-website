...
<body class="text-gray-900 font-sans">
  ...
  <!-- Header -->
  <header class="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 shadow-md">
  ...
  <!-- Hero Section -->
  <section class="bg-gradient-to-r from-yellow-100 to-orange-200 py-20 text-center">
    <h2 class="text-5xl font-bold mb-4 text-red-700">Elevate Your Event with Mobile Bar Elegance</h2>
    <p class="text-xl mb-6">Custom bar cart services for weddings, parties, and unforgettable gatherings.</p>
    <a href="#contact" class="bg-red-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-red-700 transition">Book Now</a>
  </section>

  <!-- About Section -->
  <section id="about" class="py-16 px-6 max-w-5xl mx-auto">
    <h3 class="text-3xl font-semibold mb-4 text-orange-600">About Us</h3>
  ...
  <!-- Services Section -->
  <section id="services" class="bg-yellow-50 py-16 px-6 max-w-5xl mx-auto">
    <h3 class="text-3xl font-semibold mb-8 text-center text-orange-600">Our Services</h3>
  ...
  <section id="gallery" class="py-16 px-6 max-w-5xl mx-auto">
    <h3 class="text-3xl font-semibold mb-4 text-center text-orange-600">Gallery</h3>
  ...
  <!-- FAQ Section -->
  <section id="faq" class="bg-yellow-100 py-16 px-6 max-w-5xl mx-auto">
    <h3 class="text-3xl font-semibold mb-6 text-orange-600">FAQs</h3>
    <div class="space-y-4">
      <div>
  ...
  <section id="contact" class="py-16 px-6 max-w-3xl mx-auto">
    <h3 class="text-3xl font-semibold mb-4 text-center text-orange-600">Book Now</h3>
  ...
  <!-- Footer -->
  <footer class="bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 text-center py-6 text-white">
